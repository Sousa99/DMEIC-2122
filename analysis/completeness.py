...
for iteration in iterations:
    ...
    for container in g.containers: g.bar_label(container, fmt='%0.2f', fontsize=17, fontweight="bold")
    plt.xticks(fontsize=15)
    plt.xlabel("Diagnosis", fontsize=17)
    plt.yticks(fontsize=15)
    plt.ylabel("# Records", fontsize=17)
    ...
    for ax in g.axes.ravel():
        ...
        ax.set_xticklabels([str(i) for i in AGES_CATEGORIES], fontsize = 15, rotation=45, ha="right")
        ax.set_xlabel("Age", fontsize=17)
        ax.set_ylabel("# Records", fontsize=17)
        
        ax.bar_label(ax.containers[0], fontsize=17, fontweight="bold")
    plt.yticks(fontsize=15)
    plt.tight_layout()
    ...
    for ax in g.axes.ravel():
        ax.set_title(ax.get_title(), fontsize=17)        
        ax.set_xticklabels([str(i) for i in SCHOOLINGS_CATEGORIES], fontsize = 15, rotation=45, ha="right")
        ax.set_xlabel("Schooling", fontsize=17)
        ax.set_ylabel("# Records", fontsize=17)
