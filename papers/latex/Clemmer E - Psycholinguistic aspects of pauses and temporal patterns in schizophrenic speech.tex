...
\section{Psychosis Characteristics}
    \begin{itemize}
        ...
        % $CHARACTHERISTIC{Disruption of Syntax Rules; 0.5}
        ...
        % $CHARACTHERISTIC{Preoccupation with Syntax Rules; 0.5}
...
\section{Techniques}
    \begin{itemize}
        % $TECHNIQUE{Matching of Control with Schizophrenic; 0.5}
...
\section{Problems}
    \begin{itemize}
        ...
        % $PROBLEM{Patients under Lobotomy}
