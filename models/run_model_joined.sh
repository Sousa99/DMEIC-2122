...
python3 model_joined.py -info_controls=${CONTROL_INFO} -info_psychosis=${PSYCHOSIS_INFO} -info_bipolars=${BIPOLAR_INFO} \
    ...
    -variations_key=${VARIATION_KEY} -print_variations