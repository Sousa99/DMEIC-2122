...
class WebScraperBooking(scraper.WebScraper[ScrapedInfoBooking]):
    ...
    def scrape_page(self, link: str, driver: driver.Driver) -> Generator[ScrapedInfoBooking, None, None]:
        ...
        while True:
            ...
            driver.driver_click_css('#review_list_page_container > div.c-pagination > div > div.bui-pagination__nav > div > div.bui-pagination__item.bui-pagination__next-arrow > a')
