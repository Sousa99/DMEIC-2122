...
for ((extract_index = 0; extract_index < ${#extract_lines[@]} ; extract_index += ${extracts_per_run} )); do
    ...
    echo "python3 ./extraction_dictionary_fast.py -extracts_per_run ${extracts_per_run}     \\" >> "${script_file}"
...
python3 extraction_dictionary_fast.py -parallelization_key final
