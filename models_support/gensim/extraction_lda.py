...
PATH_TO_LDA_MODELS_DIRECTORY        : str   = '../exports/gensim/lda_variations/'
PATH_TO_LDA_MODELS_TOPIC_COHERENCE  : str   = '../exports/gensim/lda_topics_coherence.png'
PATH_TO_LDA_BEST_MODEL              : str   = '../exports/gensim/lda_best_model.bin'
PATH_TO_LDA_BEST_MODEL_TOPICS       : str   = '../exports/gensim/lda_best_model_topics.txt'
